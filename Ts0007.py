...
def login():
	...
	try:
		...
		print('	   \033[1;94m♡\x1b[1;91m》》》》》》LOGIN WITH TOKEN 《《《《《《\x1b[1;94m♡' )
		print('	' )
		...
		if 'save-device' in url:
			try:
				...
				data = {"api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email="+(id)+"&locale=en_US&password="+(pwd)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6"}
				z=json.load(data)
